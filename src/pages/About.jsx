...
const About = () => {
  return (
    <div>
      <div className=''>
        <img className='relative opacity-75' src="src/assets/1740019302204.avif" alt="" />
      ...
      <div className=' mt-30 '>
        <div className='flex flex-1/2'>
            <img className='w-1/2 ml-20' src="src/assets/1740065436214.avif" alt="" />
        ...
        <div className='flex flex-row mt-10'>
            ...
            <h3 className='font-semibold text-zinc-400'>Experience top-quality service in under 3 hours with Mercedes- <br /> Benz Premier Express Prime. Our trained technicians ensure fast, <br /> hassle-free maintenance for your vehicle.</h3>
             ...
             <img className='w-1/2 ml-30' src="src/assets/1740065436265.webp" alt="" />
        </div>
        <div className='flex flex-1/2 mt-10'>
            <img className='w-1/2 ml-20' src="src/assets/1740065430575.avif" alt="" />
            <div className='mt-30 ml-20'>
        ...
        <div className='flex flex-row mt-10'>
            ...
            <h3 className='font-semibold text-zinc-400'>With your Mercedes-Benz electric or plug-in hybrid vehicle, you’ll <br /> have a wide range of simple charging options at your disposal.</h3>
             ...
             <img className='w-1/2 ml-30' src="src/assets/1740019297000.avif" alt="" />
        </div>
      </div>
      ...
      <div className='flex justify-between flex-row mt-10 mb-10 px-5'>
        <div className='bg-zinc-300 rounded-lg shadow-md overflow-hidden w-[22%]'>
          <img src="src/assets/iris.webp" className="h-40 w-full object-cover" alt="All Models" />
          <div className='p-3'>
        ...
        <div className='bg-zinc-300 rounded-lg shadow-md overflow-hidden w-[22%]'>
          <img src="src/assets/iris.avif" className="h-40 w-full object-cover" alt="Available New Cars" />
          <div className='p-3'>
        ...
        <div className='bg-zinc-300 rounded-lg shadow-md overflow-hidden w-[22%]'>
          <img src="src/assets/iris (1).webp" className="h-40 w-full object-cover" alt="Configure New Car" />
          <div className='p-3'>
        ...
        <div className='bg-zinc-300 rounded-lg shadow-md overflow-hidden w-[22%]'>
          <img src="src/assets/1740019302204.avif" className="h-40 w-full object-cover" alt="Contact" />
          <div className='p-3'>
